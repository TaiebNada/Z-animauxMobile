...
if (k>=0){
    ...
    private void addButton(String nom, String lieu, String theme, String image, Date date, Evenement eve, Resources res) throws IOException {
        ...
        String dated = sdfr.format(date);

        Label ldate = new Label(dated);
