...
public class ReclamationService {
    ...
    public ArrayList<Reclamation> getListReclamations() {
        ...
        String Url = "http://localhost/ProjetPi2/web/app_dev.php/Boutique/all/"+SignInForm.getEmailU();
        con.setUrl(Url);
     ...
     public ArrayList<Reclamation> rechercheSkill() {
      ...
      ConnectionRequest con = new ConnectionRequest();
      con.setUrl("http://localhost/ProjetPi2/web/app_dev.php/Boutique/all/"+SignInForm.getEmailU());
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    for (Map<String, Object> obj : list) {
                        ...
                        //skill.setDateR((Date)obj.get("DateR"));
                        
//                        System.out.println((Date)obj.get("DateR"));
                        
                        
                        int mm = Display.getInstance().convertToPixels(3);
                    skill.setImagePath("file://C:/wampNada/www/ProjetPi2/web/uploads/images/products/smile.png" /*+ obj.get("image").toString()*/);
                   // skill.setImagePath("file://C:/Users/HP/AppData/Local/Temp/" + obj.get("image").toString());
                    ...
                    //  imageio.save(FileSystemStorage.getInstance().openInputStream("file://C:/Users/HP/AppData/Local/Temp/" + obj.get("image").toString()),          
                      out,
                                ImageIO.FORMAT_PNG,
                                100, 100, 1);
                    } catch (IOException ex) {
    ...
    {
        ConnectionRequest con = new ConnectionRequest();
       String Url = "http://localhost/ProjetPi2/web/app_dev.php/Boutique/ajoutreclamation2?nom="+ta.getEmail()+"&email="+ta.getNom()+"&titre="+ta.getTitre()+"&mobile="+ta.getTel()+"&subject="+ta.getObjet()+"&image="+ta.getImagePath();
       con.setUrl(Url);
